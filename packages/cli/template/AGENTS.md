...
|------------|------------|
| `.agents/skills/create-board/SKILL.md` | User asks for a brand-new board |
| `.agents/skills/add-section/SKILL.md` | User asks to add a section to an existing board |
| `.agents/skills/arrange-layout/SKILL.md` | User asks to rearrange / re-layout sections |
| `.agents/skills/apply-comments/SKILL.md` | After the user used the in-browser Inspector |
| `.agents/skills/board-authoring/SKILL.md` | Reference card — read before writing any Section |
